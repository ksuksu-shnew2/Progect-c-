...
// List<char> vowels = ['а', 'у', 'о', 'и', 'э', 'ы', 'я', 'ю', 'е', 'ё'];
// Dictionary<char, int> letterCodes = new();
...
// foreach (KeyValuePair<char, int> item in letterCodes) 

//   { 
//      Random rnd = new();
//      var code = rnd.Next(1072, 1106);
...
//     static void Main()
//     {
//         // **Описание**: Создайте программу, которая использует цикл foreach для обхода массива строк и выводит только те строки, которые содержат букву 'e'.
//         // **Входные данные**: Используйте встроенный массив строк: ["apple", "banana", "grape", "orange", "kiwi"]
//         // **Выходные данные**: Каждая строка, содержащая букву 'e', на отдельной строке
//         // **Ограничения**: 
//         // - Используйте цикл foreach
//         // - Проверяйте наличие буквы 'e' в каждой строке
//         // - Выводите только подходящие строки

//         string[] fruits = {"apple", "banana", "grape", "orange", "kiwi"};
//         char books = 'e';


//         foreach (var elem in fruits) 
//               { 
//                 if (elem.Contains(books))
...
//     static void Main()
//     {
//         // **Описание**: Напишите программу, которая использует цикл while для подсчета количества цифр в числе 12345.
//         // **Входные данные**: Используйте встроенное число 12345
//         // **Выходные данные**: Количество цифр в числе
//         // **Ограничения**: 
//         // - Используйте цикл while
//         // - Работайте с числом 12345
//         // - Подсчитайте количество цифр путем деления на 10
//         // **Примеры**:
//         // Input: 12345
//         // Output: 5
...
//     static void Main()
//     {
//         // **Описание**: Создайте программу, которая использует цикл do-while для вывода чисел от 1 до 3 включительно.
//         // **Входные данные**: Используйте встроенное начальное значение 1
//         // **Выходные данные**: Каждое число на отдельной строке
//         // **Ограничения**: 
//         // - Используйте цикл do-while
//         // - Начните с числа 1
//         // - Выведите числа до 3 включительно
//         // - Инкрементируйте счетчик внутри цикла
...
//     static void Main()
//     {
//         // **Описание**: Создайте программу, которая использует цикл for с двумя переменными в блоке инициализации для одновременного вывода пар чисел.
//         //
//         // **Входные данные**: Используйте встроенные значения: начальное значение первой переменной = 1, начальное значение второй переменной = 10
//         //
//         // **Выходные данные**: Каждая пара чисел на отдельной строке в формате "число1, число2"
//         //
//         // **Ограничения**: 
//         // - Используйте цикл for с двумя переменными в блоке инициализации
//         // - Первая переменная увеличивается на 1 каждую итерацию
//         // - Вторая переменная уменьшается на 1 каждую итерацию
//         // - Остановите цикл когда первая переменная станет больше второй
//         // - Выполните только одно действие в теле цикла (вывод пары)
...
//     static void Main()
//     {
//         // **Описание**: Создайте программу, которая использует цикл for с оператором continue для вывода только нечетных чисел от 1 до 9 включительно.
//         //
//         // **Входные данные**: Используйте встроенный диапазон чисел от 1 до 9 включительно
//         //
//         // **Выходные данные**: Каждое нечетное число на отдельной строке
//         //
//         // **Ограничения**: 
//         // - Используйте цикл for для итерации от 1 до 9
//         // - Используйте оператор continue для пропуска четных чисел
...
//     static void Main()
//     {
//         // **Описание**: Напишите программу, которая использует цикл for с оператором break для поиска первого числа, которое делится на 7, в заданном диапазоне от 15 до 30.
//         // **Входные данные**: Используйте встроенный диапазон чисел от 15 до 30 включительно
//         // **Выходные данные**: Первое найденное число, которое делится на 7
//         // **Ограничения**: 
//         // - Используйте цикл for для итерации от 15 до 30
//         // - Используйте оператор break для выхода из цикла при нахождении первого числа
//         // - Проверяйте деление на 7 с помощью оператора модуль (%)
...
//     static void Main()
//     {
//         // **Описание**: Напишите программу, которая использует вложенные циклы for для создания простой таблицы умножения 3x3.
//         // **Входные данные**: Используйте встроенные значения: размер таблицы 3x3 (строки от 1 до 3, столбцы от 1 до 3)
//         // **Выходные данные**: Таблица умножения в формате "строка * столбец = произведение" для каждой комбинации
//         // **Ограничения**: 
//         // - Используйте два вложенных цикла for
//         // - Внешний цикл для строк (от 1 до 3)
//         // - Внутренний цикл для столбцов (от 1 до 3)
//         // - Выводите результат умножения для каждой пары
...
//             {
//               proizvedenie = i*j;
//                 Console.WriteLine($"{i} * {j} = {proizvedenie}");
//             }
//             Console.WriteLine();
//         }
//     }
...
//     static void Main()
//     {
//         // **Описание**: Создайте программу, которая использует цикл for для создания и заполнения массива квадратов чисел от 1 до 5, а затем выводит каждый элемент массива.
//         //
//         // **Входные данные**: Используйте встроенный диапазон чисел от 1 до 5 включительно
//         //
//         // **Выходные данные**: Каждый квадрат числа на отдельной строке
//         //
//         // **Ограничения**: 
//         // - Используйте цикл for для заполнения массива
//         // - Создайте массив размером 5 элементов
//         // - Заполните массив квадратами чисел от 1 до 5
...
//                     int proizvedenie = i*i;
//                     matrix[i-1] = proizvedenie; 
...
//     static void Main()
//     {
//         // **Описание**: Создайте программу, которая использует цикл while для подсчета количества символов в строке "programming" путем последовательного удаления символов.
//         // **Входные данные**: Используйте встроенную строку "programming"
//         // **Выходные данные**: Количество символов в строке
//         // **Ограничения**: 
//         // - Используйте цикл while
//         // - Работайте со строкой "programming"
//         // - Подсчитайте количество символов путем последовательного удаления первого символа
//         // - Используйте метод Substring для удаления символов
...
//         while (text != "")
//     {
//           string simbol = text.Substring(0,1);
